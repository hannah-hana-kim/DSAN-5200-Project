...
subplot_malnourished <- averages %>%
  ...
  layout(title = "<b>Average Malnourishment Rate (2000-2020)<b>",
         xaxis = list(title = "<b>Year<b>", tickvals = seq(2000, 2020, by = 2)),
...
subplot_obesity <- averages %>%
  plot_ly(x = ~Year, y = ~`Avg Obesity %`, color = ~Continent, colors=colors, type = 'scatter', mode = 'lines+markers', showlegend=TRUE, text=~Obesity_Perc_Diff, hovertemplate = paste("%{y:.2f}% (%{text}% increase)", "<extra></extra>"), marker = list(size = 8)) %>%
  layout(title = "<b>Average Obesity Rate (2000-2020)<b>",
...
malnourished_africa <- plot_ly(africa_data, x = ~Year, y = ~`Avg Malnourished %`, type = 'bar', color = ~Continent, colors = colors, showlegend = FALSE, text=~Malnourished_Perc_Diff, hovertemplate = paste("%{y:.2f}% (%{text}% change)")) %>%
  layout(title = "<b>Average Malnourishment Rate in Africa and Europe (2000-2020)</b>",
         xaxis = list(title = "<b>Year<b>", tickvals = seq(2000, 2020, by = 2)),
...
malnourished_europe <- plot_ly(europe_data, x = ~Year, y = ~`Avg Malnourished %`, type = 'bar', color = ~Continent, colors = colors, showlegend = FALSE, text=~Malnourished_Perc_Diff, hovertemplate = paste("%{y:.2f}% (%{text}% change)")) %>%
  layout(xaxis = list(title = "<b>Year<b>", tickvals = seq(2000, 2020, by = 2)),
         yaxis = list(title = "<b>Avg Malnourishment %<b>", 
                      range = c(0,25), 
                      tickvals = seq(0, 25, by = 5), 
                      ticktext = paste0(seq(0, 25, by = 5), "%")), 
...
subplot_barcharts <- subplot(
  malnourished_africa, malnourished_europe,
  nrows = 2, margin = 0.05
)
subplot_barcharts
...
# obesity plots
obesity_africa <- plot_ly(africa_data, x = ~Year, y = ~`Avg Obesity %`, type = 'bar', color = ~Continent, colors = colors, showlegend = FALSE, text=~Obesity_Perc_Diff, hovertemplate = paste("%{y:.2f}% (%{text}% increase)")) %>%
  layout(title = "<b>Average Obesity Rate in Africa and Europe (2000-2020)</b>",
         xaxis = list(title = "<b>Year<b>", tickvals = seq(2000, 2016, by = 2)),
...
obesity_europe <- plot_ly(europe_data, x = ~Year, y = ~`Avg Obesity %`, type = 'bar', color = ~Continent, colors = colors, showlegend = FALSE, text=~Obesity_Perc_Diff, hovertemplate = paste("%{y:.2f}% (%{text}% increase)")) %>%
  layout(xaxis = list(title = "<b>Year<b>", tickvals = seq(2000, 2016, by = 2)),
         yaxis = list(title = "<b>Avg Obesity %<b>", 
                      range = c(0,25), 
                      tickvals = seq(0, 25, by = 5), 
                      ticktext = paste0(seq(0, 25, by = 5), "%")), 
...
choropleth <- subset(choropleth, select=-subregion)
...
colorbar(title = "<b>Rate<b>") %>%
layout(
  title = "<b>Average Obesity Rate (2000-2020)<b>",
  geo = list(scope = "world", projection = list(type = "equirectangular"), showlakes = FALSE,
    showland = TRUE,
    showcountries = TRUE,
    showcoastlines = TRUE,
...
colorbar(title = "<b>Rate<b>")%>%
layout(
  title = "<b>Average Malnourishment Rate (2000-2020)<b>",
  geo = list(scope = "world", projection = list(type = "equirectangular"), showlakes = FALSE,
    showland = TRUE,
    showcountries = TRUE,
    showcoastlines = TRUE,
